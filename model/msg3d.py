...
class Model(nn.Module):
    def __init__(self,
        ...
        Graph_2 = import_class(graph_2)
        A_binary = Graph().A_binary
        A_binary_2 = Graph_2().A_binary
        ...
        self.gcn3d1_2 = MultiWindow_MS_G3D(3, c1, A_binary_2, num_g3d_scales, window_stride=1)
        ...
        self.gcn3d2_2 = MultiWindow_MS_G3D(c1, c2, A_binary_2, num_g3d_scales, window_stride=2)
        ...
        self.gcn3d3_2 = MultiWindow_MS_G3D(c2, c3, A_binary_2, num_g3d_scales, window_stride=2)
    ...
    def forward(self, x):
        ...
        x = F.relu(self.sgcn1(x) + self.gcn3d1(x) + self.gcn3d1_2(x), inplace=True)
        x = self.tcn1(x)

        x = F.relu(self.sgcn2(x) + self.gcn3d2(x) + self.gcn3d2_2(x), inplace=True)
        x = self.tcn2(x)

        x = F.relu(self.sgcn3(x) + self.gcn3d3(x) + self.gcn3d3_2(x), inplace=True)
        x = self.tcn3(x)
